...
class ReservationServiceTest {
    ...
    void createReservation_Overlapping() {
        ...
        when(reservationRepository.countOverlappingReservations(1L, request.getStartTime(), request.getEndTime(), ReservationStatus.CANCELLED)).thenReturn(1L);
    ...
    void createReservation_Success() {
        ...
        when(userRepository.findByUsername("testuser")).thenReturn(Optional.of(user));
        when(resourceRepository.findById(1L)).thenReturn(Optional.of(resource));
        when(reservationRepository.countOverlappingReservations(1L, request.getStartTime(), request.getEndTime(), ReservationStatus.CANCELLED)).thenReturn(0L);
